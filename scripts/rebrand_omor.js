...
const replacements = [
  // Emails & Domains
  ['concierge@trishnaelectronics.com', 'concierge@omorautocorner.com'],
  ['support@trishnaelectronics.com', 'support@omorautocorner.com'],
  ['info@trishnaelectronics.com', 'info@omorautocorner.com'],
  ['TrishnaElectronics.com', 'OmorAutoCorner.com'],
  ['trishnaelectronics.com', 'omorautocorner.com'],
  
  // Specific case-sensitive matches
  ['Trishna Electronics', 'Omor Auto Corner'],
  ['trishna electronics', 'omor auto corner'],
  ['TrishnaElectronics', 'OmorAutoCorner'],
  ['TRISHNA ELECTRONICS', 'OMOR AUTO CORNER'],
  ['trishnaelectronics-app', 'omorautocorner-app'],
  ['trishna-electronics', 'omor-auto-corner'],
  ['trishnaelectronics', 'omorautocorner'],
];
...
function walkDir(dir) {
  ...
  files.forEach(file => {
    ...
    if (stat.isDirectory()) {
      ...
      // Specifically skip bd-locations.ts to avoid renaming geographic references
      if (file === 'bd-locations.ts') {
        return;
      }
      
      // Skip binary/lock files and self
      if (file === 'package-lock.json' || file === 'rebrand_omor.js') {
        return;
      }
