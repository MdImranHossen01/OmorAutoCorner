...
const fallbackReviews = [
  {
    name: "Ariful Islam",
    role: "Verified Buyer",
    content: "The quality of the motorcycle parts is amazing. I was skeptical about ordering engine oil online, but this shop proved me wrong. Delivery was super fast too!",
  ...
  },
  {
    ...
    content: "Excellent customer service! They helped me choose the right DOT certified helmet for my daily commute. The checkout process was smooth as silk. Highly recommended.",
  ...
  },
  {
    ...
    content: "Bought my new MT helmet and touring accessories from here. Genuine product with official warranty support. The packaging was very secure. Keep up the good work!",
  ...
  },
  {
    name: "Nusrat Jahan",
    role: "Verified Buyer",
    content: "I love the variety of motorcycle modification parts they have. It's my one-stop shop for bike accessories. The prices are very competitive compared to other local shops.",
