  ...
  try {
    ...
    if (!settings) {
      return NextResponse.json({
        brandName: process.env.NEXT_PUBLIC_STORE_NAME || "Omor Auto Corner",
        contact: {
        ...
        marqueeText: "Welcome to Omor Auto Corner!",
        metaTitle: process.env.NEXT_PUBLIC_STORE_NAME || "Omor Auto Corner",
