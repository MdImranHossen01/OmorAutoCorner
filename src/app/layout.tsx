  ...
  try {
    ...
    return {
      ...
      appleWebApp: {
        ...
        title: settings.brandName || "Omor Auto Corner",
      },
      formatDetection: {
        telephone: false,
      },
      openGraph: {
        title: settings.metaTitle || settings.brandName || "Omor Auto Corner",
        description: settings.metaDescription || settings.brandName || "Your ultimate destination for quality products.",
        url: baseUrl,
        siteName: settings.brandName || "Omor Auto Corner",
        type: 'website',
      },
      twitter: {
